...
- git init (this cmd creates local Repo(this is local repo '.git/' mostly this is hidden) inside ur folder )
- git add .
- git commit -m "Initial commit"
- git branch -M main
- git remote add origin https://github.com/"your_username"/"REPO_NAME".git (this cmd connects that local Git repository to the GitHub repository)
